...
describe("Attacking Saddle...", function () {
  it("test", async function () {
    ...
    const LiquidationOperator = await ethers.getContractFactory("AttackOperator");
    const attackOperator = await LiquidationOperator.deploy(overrides = {gasPrice: gasPrice});
    await attackOperator.deployed();

    const liquidationTx = await attackOperator.operate(overrides = {gasPrice: gasPrice});
